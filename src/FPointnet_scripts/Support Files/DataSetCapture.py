...
cntr=398
#dataset path
path='/home/rauldds/catkin_ws/src/vttc/Real_Dataset/'
#path for labeling
...
img_sub = message_filters.Subscriber('/zed/zed_node/left_raw/image_raw_color', Image)
pc2_sub = message_filters.Subscriber('velodyne_points', PointCloud2)

ts = message_filters.ApproximateTimeSynchronizer([img_sub, pc2_sub], 10,0.1, allow_headerless=True)
print("hola")
